...
!     CHARACTER*2   CROP
      ...
      REAL TAR0, TDELAY, LER0, SER0, LG_AMBASE, AQP_UP5 
...
!     09/21/2009 CHP/KAD
     ...
     &     char_name=(/'VARNO   ','VRNAME  ','PLAINTXT'/),
     &     real_name=(/'PHTHRS(8)'/))
...
!     CropSim: wheat, barley
     ...
     &     real_name=(/'P1       ','P2       ','P3       ','P4       ',
     &                 'P5       ','P6       ','P7       ','P8       ',
     &                 'VREQ     ','VBASE    ','VEFF     ','PPS1     ',
     &                 'PPS2     ','PHINT    ','LA1S     ','LAFV     ',
...
C-GH &      SNFX, SRNWT, SRFR, HMPC, PHINT, LA1S, LAXS, LAXND, LAXN2,
     ...
     &      LAFS, LAFND, SLASS, LLIFA, LPEFR, STFR, PLAINTXT
        ...
        call csminp%add_var('*CULTIVAR',
     &     char_name=(/'VARNO   ','VRNAME  ','ECONO   ','PLAINTXT'/),
     &     real_name=(/'PPS1     ','B01ND    ','B12ND    ','B23ND    ',
     &                 'B34ND    ','B45ND    ','B56ND    ','SRNWT    ',
     &                 'SRFR     ','HMPC     ','PHINT    ','LA1S     ',
     &                 'LAXS     ','LAXND    ','LAXN2    ','LAFS     ',
     &                 'LAFND    ','SLASS    ','LLIFA    ','LPEFR    ',
     &                 'STFR     ','PHTHRS(8)'/))
...
!WDB** end changes
     ...
     &                   'PHYL1','PHYL2','FRSUG','DRCER'/))
        ...
        call csminp%put('*CULTIVAR','G2',G2)
        call csminp%put('*CULTIVAR','G3',G3)
        call csminp%put('*CULTIVAR','PHYL1',PHYL1)
        call csminp%put('*CULTIVAR','PHYL2',PHYL2)
        call csminp%put('*CULTIVAR','FRSUG',FRSUG)
        call csminp%put('*CULTIVAR','DRCER',DRCER)
...
!    &            P1,P2R,P5,P2O,G1,G2,G3,G4, PHINT, G5
     ...
     &                 'TCLDF'/))
        ...
        call csminp%put('*CULTIVAR','G3',G3)
        call csminp%put('*CULTIVAR','PHINT',PHINT)
        call csminp%put('*CULTIVAR','THOT',THOT)
        call csminp%put('*CULTIVAR','TCLDP',TCLDP)
        call csminp%put('*CULTIVAR','TCLDF',TCLDF)
...
!     Simulador Agronomico Modular de Cana-de-Acucar
     ...
     &                   'end_tt_lf_growth     '/))
        ...
        call csminp%put('*CULTIVAR','VRNAME',VRNAME)
        call csminp%put('*CULTIVAR','ECONO',ECONO)
        call csminp%put('*CULTIVAR','maxgl_r',maxgl_r)
        call csminp%put('*CULTIVAR','n_lf_when_stk_emerg_r',
     &                    n_lf_when_stk_emerg_r)
        call csminp%put('*CULTIVAR','n_lf_it_form_r',n_lf_it_form_r)
        call csminp%put('*CULTIVAR','maxdgl_r',maxdgl_r)
        call csminp%put('*CULTIVAR','amax',amax)
        call csminp%put('*CULTIVAR','eff',eff)
        call csminp%put('*CULTIVAR','chustk',chustk)
        call csminp%put('*CULTIVAR','chupeak',chupeak)
        call csminp%put('*CULTIVAR','chudec',chudec)
        call csminp%put('*CULTIVAR','chumat',chumat)
        call csminp%put('*CULTIVAR','popmat',popmat)
        call csminp%put('*CULTIVAR','poppeak',poppeak)
        call csminp%put('*CULTIVAR','tillochron',tillochron)
        call csminp%put('*CULTIVAR','phyllochron',phyllochron)
        call csminp%put('*CULTIVAR','sla',sla)
        call csminp%put('*CULTIVAR','mla',mla)
        call csminp%put('*CULTIVAR','plastochron',plastochron)
        call csminp%put('*CULTIVAR','init_leaf_area',init_leaf_area)
        call csminp%put('*CULTIVAR','max_ini_la',max_ini_la)
        call csminp%put('*CULTIVAR','max_it_dw',max_it_dw)
        call csminp%put('*CULTIVAR','mid_tt_it_growth',
     &                     mid_tt_it_growth)
        call csminp%put('*CULTIVAR','end_tt_it_growth',
     &                     end_tt_it_growth)
        call csminp%put('*CULTIVAR','mid_tt_lf_growth',
     &                     mid_tt_lf_growth)
        call csminp%put('*CULTIVAR','end_tt_lf_growth',
     &                     end_tt_lf_growth)
...
!!     Sunflower **
     ...
     &                 'O1   '/))
        ...
        call csminp%put('*CULTIVAR','G2',G2)
        call csminp%put('*CULTIVAR','G3',G3)
        call csminp%put('*CULTIVAR','O1',O1)
